#!/usr/bin/env bash
# Stage3 完走後 eval バッテリー（レンズ1: 標準argmax、stage3_design.md §6-1）
# checkpoints: init / 2000 / 4000 / 8000 / 12000 / 16000 (stage3_20260712_033403、単一 run・クラッシュなし)
# 自然分布 (p_enrich=0、eval 経路の既定)、call_bonus_b=0（eval 経路の既定）、
...
echo "=== Stage3 eval battery (lens1: standard argmax): $(date -Iseconds) ==="
