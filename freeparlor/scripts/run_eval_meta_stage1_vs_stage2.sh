#!/usr/bin/env bash
# メタ対決 probe (stage2_design.md §5 レンズ3):
# challenger = Stage2 step16000 (stage2_20260709_194510_resume)
...
echo "=== Stage2 meta probe (Stage2 step16000 vs Stage1 step16000): $(date -Iseconds) ==="
...
label="meta_stage2step16000_vs_stage1step16000"
...
echo ""
echo "=== Summary (challenger=Stage2 step16000 視点 vs baseline=Stage1 step16000 ×3, 400 半荘) ==="
if [[ -f "$log" ]]; then
