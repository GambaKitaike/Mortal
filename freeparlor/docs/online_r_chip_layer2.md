...
層3  train.py / model.py 側の n-step 報酬合成・学習     ✅
```
...
- n-step (n=3, 局内 truncate): `R = Σ γ^k r_chip[i+k]`, bootstrap = `i+n` ✅
- `r_chip` は既に trainee 最終 move に集約済み。層3 実装完了 → `freeparlor/docs/online_r_chip_layer3.md`
